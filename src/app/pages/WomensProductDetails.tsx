...
import imgFrame239 from "figma:asset/a7bd8f94aa8209f92fa4986a16a8b5cbecee02b3.png";
...
import imgFrame247 from "figma:asset/4a169adeb8089fb4ceb1691abba749f508f56c96.png";
...
export function WomensProductDetails() {
  return (
    <ProductDetailsPage
      ...
      relatedProducts={[
        { id: 1, name: "Collection Alpha", image: imgFrame247 },
